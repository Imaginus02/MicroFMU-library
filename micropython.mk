...
CFLAGS_USERMOD += -I$(CLIBRARY_MOD_DIR) -I$(CLIBRARY_MOD_DIR)/headers -I$(CLIBRARY_MOD_DIR)/fmu/sources  -Wall -g -Wno-double-promotion -Wno-error -DFMI2_OVERRIDE_FUNCTION_PREFIX="" -fno-common -DFMI_VERSION=2 -v #-DMODEL_IDENTIFIER=BouncingBall -DModelFMI_COSIMULATION=0
